...
def calculate_frequency(frequency):
    letters_dictionary = frequency(main_str)
    new_dictionary = {}
    for key, value in letters_dictionary.items():
        new_dictionary[key] = letters_dictionary.get(key) / sum(letters_dictionary.values())
...
result = calculate_frequency(count_letters)
